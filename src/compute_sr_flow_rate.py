...
def create_plot_and_save_sr_flow_rate(cases, datas, Q_bosi, model, condition):
    ...
    for i, case in enumerate(cases):
        ...
        Q_mv = get_mv_flow_rate_for_condition(
            time, area_mv, area_avg, volume_la, volume_avg, Q_bosi, optimal_n, model, condition
        )
...
if __name__ == "__main__":
    ...
    for model in models:
        ...
        # Create flow rate
        create_plot_and_save_sr_flow_rate(cases, all_model_data, Q_bosi, model, condition)

...
ROOT = "data"
INFO_PATH = path.join(ROOT, "model_info/model_info_{}/{}/model_info.json")
FLOW_EXTENSION_LENGTH_PATH = path.join(ROOT, "flow_extension_lengths/flow_extension_lengths_{}.json")

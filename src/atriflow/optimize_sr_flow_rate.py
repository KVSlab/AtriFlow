...
def main():
    # Get references
    global reference_co, reference_co_sd, reference_pv_velocity, reference_pv_velocity_sd, reference_mv_velocity, reference_mv_velocity_sd, reference_bpm, reference_bpm_sd
